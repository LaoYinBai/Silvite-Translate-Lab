...
export const DEMO_SAMPLES: DemoSample[] = [
  ...
  },
  {
    ...
    result: {
      ...
      sourceLanguage: 'zh',
      targetLanguage: 'en',
      translation: 'Title: The Belated Promise\nCaption: Dusk, at the school gate.\nA: "Why are you only showing up now?!"\nB: "The roads were jammed — I ran the whole way here!" *huff, huff*\nA: "Look at you — catch your breath first."\nB: "It\'s fine. When I promise you something, I show up."\nA: "Fine, let\'s get dinner. We can talk on the way."\nB: "Sure — my treat."',
      detectedText: '迟到的约定\n傍晚，校门口。\n你怎么现在才来！\n路上堵死了，我已经一路跑过来了！\n呼——呼——\n看你这样子，先喘口气吧。\n没事，答应你的事我总得赶上。\n行吧，那先去吃饭，边走边说。\n好，我请你。',
      segments: [
        ...
        seg('dialogue', '路上堵死了，我已经一路跑过来了！', '"The roads were jammed — I ran the whole way here!"'),
        seg('sound_effect', '呼——呼——', '*huff, huff*'),
        seg('dialogue', '看你这样子，先喘口气吧。', '"Look at you — catch your breath first."'),
        seg('dialogue', '没事，答应你的事我总得赶上。', '"It\'s fine. When I promise you something, I show up."'),
        seg('dialogue', '行吧，那先去吃饭，边走边说。', '"Fine, let\'s get dinner. We can talk on the way."'),
        seg('dialogue', '好，我请你。', '"Sure — my treat."'),
      ],
      notes: [
